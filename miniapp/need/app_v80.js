      ...
      if (sub && sub.isActive) {
        ...
        statusHtml += `
          <div style="display: flex; gap: 8px; width: 100%;">
            <button class="btn-primary" style="flex:1; padding: 0 4px; font-size: 14px;" onclick="window.showScreen('screenSetup')">Подключиться</button>
            <button class="btn-secondary" style="flex:1; padding: 0 4px; font-size: 14px;" onclick="window.showModal('modalPlan')">Продлить</button>
          </div>
        `;
